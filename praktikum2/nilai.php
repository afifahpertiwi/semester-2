  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Afifah Pertiwi</a>
        </div>
      </div>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="praktikum1/table.php" class="nav-link">
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="praktikum2/belanjaan .php" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Belanja</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="praktikum2/data.php" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Data siswa</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="praktikum2/nilai.php" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Nilai Siswa</p>
                    </a>
                  </li>
              ...
              <li class="nav-item">
                <a href="praktikum3/pemrogramanweb/hasil.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>praktikum 3</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="praktikum4/form.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>praktikum 4</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="Praktikum5/Praktikum 5/dispenser.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Praktikum 5</p>
              </li>
              <li class="nav-item">
                <a href="BMI/Pasien.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>BMI</p>
                </a>
              </li>
    ...
    <div class="m-5 border border-success p-4 rounded">
        <form method="GET"autocomlate ="off" action="from_nilai.php">
            <div class="form-group row">
                ...
                <div class="input-group">
                    ...
                    <input id="teext" name="nama" placeholder="Masukan Nama Lengkap Anda" type="text" class="form-control"require="requidred">
                </div>
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col=8">
                <select name="matkul" id="select" require="require" class="custom-select">
            ...
            <div class="form-group row">
                ...
                <div class="input-group">
                    ...
                    <input id="text1"name="nilai_uts" placeholder="Masuin Nialai Uts Anda" type="number" class="form-control" require="require">
                </div>
                </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
            ...
            <div class="input-group">
                ...
                <input id="text3" name="nilai_tugas" placeholder="Masukan Nilai Tugas/Pratikum" type="number" class="from-control" require="required">
            </div>
            </div>
        </div>
        <div class="form-group-row">
            <div class="offset-4 col-8">
                <button name="sumbit" type="sumbit" class="btn btn-success">sumbit</button>
            </div>
        </div>
        </form>
    </div>
